...
window.UpdateProductComponent = React.createClass({
    ...
    componentDidMount: function(){
        ...
        // read categories
        this.serverRequestCat = $.get("http://localhost/my_super_app/api/category/read.php",
            function (categories) {
                this.setState({
        ...
        this.serverRequestProd = $.get("http://localhost/my_super_app/api/product/read_one.php?id=" + productId,
            function (product) {
